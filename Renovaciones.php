...
<body>
	...
	<div class="ConScroll">		
				<?php
					list($RevisionId, $Nombre, $Ciudad, $Rfc)=$Herramientas->getDatosClientesReactivacion($Nombre);
					$HerramientasHtml->displayDatosClientesReactivacion($RevisionId, $Nombre, $Ciudad, $Rfc);
					unset($_POST['Nombre']);
				?>	
		<br><br>
	</div>
