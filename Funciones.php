...
<body>
	...
	<div id="Contenido">
		<div id="Titulo">
			<input type="hidden" id="ModuloId" name="ModuloId" value="6">
			<img class="tituloImg" src="img/Funciones.png" />
			Funciones
		</div>	
		...
		<div id="Sesion">
			...
			<form id="foo" name="foo" method="post" >
				...
				<fieldset>
					<legend>Administracion de Funciones</legend>
						<?php $HerramientasHtml->DisplayControles(6,1); ?>
					<br>
					<div align="center" id="resultados"></div>
					<div class="Izquierda">
					<label for="Funcion"><span class="importante">*</span>Funcion:</label>
					<textarea id="Funcion" name="Funcion"></textarea>
					</div>
					<div class="Derecha">
									...
									if($t) $Clase='';
										...
										echo'
												<tr '.$Clase.'>
													...
													<td align="center"><input type="checkbox" name="Categoria" id="Categoria" class="cat" value="'.$A0[0].'" onclick="setFuncion(this)" /></td>
												</tr>
										';										
									$t=(!$t);	
								}
