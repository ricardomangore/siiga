...
<ul class="nav nav-tabs">
  <li><a href="recargas.php">Reporte de Recarga Electronica</a></li>
  <li class="active"><a href="depositos.php">Reporte de Depositos</a></li>
  <li><a href="#">Reporte de Ventas</a></li>
</ul>
<br><br>
<h3><b>&nbsp;&nbsp; <span class="glyphicon glyphicon-list"></span> Reporte de Depositos</b></h3>
<div class="row">
	<div class="col-md-3">
		...
		<div class="panel panel-primary">
  		...
  		<div class="panel-body">
    		<div class="row">
    			...
    			<div class="col-md-10">
    				<form action="php/depositos.php" method="post">
