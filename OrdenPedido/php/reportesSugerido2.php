<?php
	...
	header("Content-Disposition: attachment; filename=reportePedidoAutorizado.xls");
	...
	<table border="1">
	    	<tr align="center">
		<th colspan="7" style="background: #000000; color: #FFFFFF;"><font face="helvetica">  Equipos Autorizados <?php echo $semana ?> </font></th>
	</tr>
	<tr>
		<td>Semana</td>
	...
	<?php
	$query="SELECT PuntoVentaId, Equipos, PuntoVentaId, Semana FROM OrdenPedido WHERE (Semana>4 AND Semana<8) AND Estatus!='Cancelado' AND Activo=1 ORDER BY Semana";
	//echo $query;
