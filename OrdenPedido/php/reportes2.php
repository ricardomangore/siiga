...
<tr style="background: #A5A5A5">
		<td align="center"><font face="calibri" size="2"><b></b></font></td>	
			<td align="center"><font face="calibri" size="2"><b></b></font></td>	
			<td align="center"><font face="calibri" size="2"><b></b></font></td>
			<td align="center"><font face="calibri" size="2"><b></b></font></td>
			<td align="center"><font face="calibri" size="2"><b></b></font></td>
		...
		for($i=0;$i<$tamFinal-1;$i++){
			if($equiposUnicos2[$i]!=0){
				//echo $equiposUnicos2[$i].",";
				$query="SELECT Equipo, EquipoId FROM Equipos WHERE EquipoId='$equiposUnicos2[$i]'";
				$res=mysql_fetch_array(mysql_query($query));
				//echo "<td>".$res["EquipoId"]."</td>";	
				echo "<td align='center'><font face='calibri' size='2'><b>".$res["Equipo"]."</font></td>";	
			}
