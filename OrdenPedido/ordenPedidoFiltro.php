...
<html lang="es"> 
  <head>
	...
	<?php
		if($puestoId==68 || $puestoId==69 || $puestoId==7 || $puestoId==22){
			?>
    			...
    			$.ajax({
    				url: "php/todosDatosFiltro.php?filtro=+<?php echo $filtro;?>",
    				type: "POST",
    				dataType: "html",
    				cache: false,
    				contentType: false,
    ...
    var textoBusqueda = $("input#busquedaOrden").val();
     ...
     if (textoBusqueda != "") {
        $.post("php/buscarOrden.php", {valorBusqueda: textoBusqueda}, function(mensaje) {
   ...
   <div class="well" style=" background:#FFFFFF;">
	...
	<div align="center">
		<ul class="nav nav-tabs">
			<li class="active"><a href="ordenPedido.php"><b>Pedidos Semana Actual</b></a></li>
			<li ><a href="ordenPedidoHistorico.php"><b>Pedidos en Hist&oacute;rico</b></a></li>
		</ul>
	...
	<br><br><br>
		...
		if($puestoId==68 || $puestoId==69 || $puestoId==7 || $puestoId==22){
			?>
		<form action="ordenPedidoFiltro.php" method="post">
			Filtrar por: <select name="filtro">
				<option>--Selecciona una opcion--</option>
				<option>Estatus</option>
				<option>Responsable</option>
			</select>
			<button class="btn btn-success btn-xs"><span class="glyphicon glyphicon-ok"></span> Aceptar</button>
