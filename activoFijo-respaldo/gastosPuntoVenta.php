                  ...
                  <input type="hidden" value="<?php echo $puntoId;?>" name="puntoId">
                  	<table class="table table-striped">
                  		...
                  		<tr>
                  			...
                  			<td><input class="form-control" type="number" name="costo" required></td>
                  		</tr>
                  	</table>
...
<!--Fin del Modal -->
  ...
  <li><a href="contratoPuntoVenta.php?id=<?php echo $puntoId;?>">Contratos</a></li>
                 ...
                 <h4><b>Gastos Registrados</b></h4>
                 	...
                 	<?php
						$gastoFin=0;
						$queryGastos="SELECT CG.Categoria AS Categoria, GF.Descripcion AS Descripcion, GF.Costo AS Costo FROM GastoFijo AS GF INNER JOIN CategoriaGastoFijo AS CG ON GF.CategoriaGastoFijoId=CG.CategoriaGastoFijoId WHERE GF.Activo=1 AND CG.Activo=1 AND PuntoVentaId=$puntoId ORDER BY CG.Categoria";
							...
							if(mysql_num_rows($resGasto)==0){
								...
								while($rowGastos=mysql_fetch_array($resGasto)){
									...
									<tr>
										...
										<td align="center"><button class="btn btn-success btn-xs"><span class="glyphicon glyphicon-pencil"></span> Editar</button></td>
									</tr>
								<?php
