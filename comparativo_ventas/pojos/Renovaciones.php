...
class Renovaciones
{
	...
	public function getAcceessFeeSinCtrl()
	{
	    return $this->acceess_fee_sin_ctrl;
	}
	
	public function setAcceessFeeSinCtrl($acceess_fee_sin_ctrl)
	{
	    $this->acceess_fee_sin_ctrl = $acceess_fee_sin_ctrl;
	}
...
getIdLayout()
getFolio()
getNoContratoImpreso()
getSubcategoria()
getIncidente()
getIdOrdenRenovacion()
getCuentaCliente()
getFechaAltaInc()
getFecha_Firma()
getFechaCaptura()
...
getRentaServControl()
getAccessFee()
getAcceessFeeSinCtrl()
getAccessFeeServControl()
getStatusTenure()
getTipoMovimiento()
