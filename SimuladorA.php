...
<body>
	...
	<div id="Contenido">
		...
		<table id="MiTabla">
			...
			<?php
				$t=true;				
				$R0=$Herramientas->getRangoSemanal(2);
		...
		<table id="MiTabla">
			...
			<?php
				$t=true;				
				$R0=$Herramientas->getRangoMensual(2);
				while($A0=mysql_fetch_row($R0))
				{
				if($t) $Clase='';
					else $Clase='class="alt"';
		...
		<div align="right"><input type="button"  class="aceptar" id="Calcular2" name="Calcular2" value="Calcular">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
