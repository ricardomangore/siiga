...
<ul class="nav nav-tabs">
  <li class="active"><a href="recargas.php">Reporte de Recarga Electronica</a></li>
  <li><a href="depositos.php">Reporte de Depositos</a></li>
  <li><a href="#">Reporte de Ventas</a></li>
</ul>
<br><br>
<h3><b>&nbsp;&nbsp; <span class="glyphicon glyphicon-list"></span> Reporte de Recarga Electronica</b></h3>
<div class="row">
	<div class="col-md-3">
		...
		<div class="panel panel-primary">
  		...
  		<div class="panel-body">
    		<div class="row">
    			...
    			<div class="col-md-10">
    				<form action="php/recargas.php" method="post">
