	...
	<?php
		...
		while($row=mysql_fetch_array($res)){
			...
			if($row["Clave"]=='ATT a tu manera'){
				...
				if($tipoContratacion=='ADICION' || $tipoContratacion=='NUEVA'){
					$evento="ACTIVACION";
				}else{
					$evento="RENOVACION";
				}
				if($row["FamiliaPlan"]=='AZUL'){
					$plataforma="AVS";
				}else{
			...
			<tr>
				...
				<td><font face="calibri"><?php echo  $evento;?></td>
				<td><font face="calibri"><?php echo  $tipoContratacion;?></td>
				<td><font face="calibri"><?php echo  $plataforma;?></td>
				<td><font face="calibri"><?php echo  $dn;?></td>
				<td></td>
				<td><font face="calibri"><?php echo  $serie;?></td>
				<td><font face="calibri"><?php echo date("d",strtotime($fechaContrato));?></td>
				<td><font face="calibri"><?php echo $registroId;?></td>
				<td></td>
				<td></td>
				<td></td>
				<td></td>
