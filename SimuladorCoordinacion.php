...
<body>
	...
	<div id="Contenido">
		...
		<table id="MiTabla">
			...
			<tbody>
				...
				<tr>
					...
					<td><div class="signo">$</div><div class="pesos">1,500</div></td>
				</tr>
				<tr class="alt">
					<td>Semanal</td>
					<td>Mayor o igual a</td>
					<td><div class="signo">$</div><div class="pesos">4,000</div></td>
					<td><div class="signo">$</div><div class="pesos">2,000</div></td>
				</tr>
			</tbody>
		</table>
		...
		<strong>Comsiones por Volumen según periodo</strong>
			...
			<tbody>
				<tr class="alt">
					...
					<td><div class="signo">$</div><div class="pesos">2,750</div></td>
				...
				<tr>
					<td>Mensual</td>
					<td>Mayor o igual a</td>
					<td><div class="signo">$</div><div class="pesos">15,000</div></td>
					<td align="right">0.40</td>
				</tr>
				<tr class="alt">
					<td>Mensual</td>
					<td>Mayor o igual a</td>
					<td><div class="signo">$</div><div class="pesos">30,000</div></td>
		...
		<div align="right"><input type="button"  class="aceptar" id="Calcular7" name="Calcular7" value="Calcular">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
