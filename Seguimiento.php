...
<body>
	...
	<div class="ConScroll">		
				<?php
					list($SeguimientoId, $Nombre, $Municipio, $Estado, $Telefono, $Direccion, $Colonia)=$Herramientas->getDatosClientesSeguimiento($Nombre);
					$HerramientasHtml->displayDatosClientesSeguimiento($SeguimientoId, $Nombre, $Municipio, $Estado, $Telefono, $Direccion, $Colonia);
					unset($_POST['Nombre']);
				?>	
		<br><br>
	</div>
