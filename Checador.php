...
<body>
	...
	<div id="Contenido">
		...
		<?php
/*
		if(!isset($_COOKIE["isChecador"])|| $_COOKIE["isChecador"]==0)

			echo'<br><div class="alerta" align="center">Este equipo no esta configurado para utilizar el checador, por favor comunicate al arrea de sistemas 222 403 3801 ext. 116,118</div>';
			else
*/
