...
AnyTime.Converter = function(options)
{
	...
	*/
	...
	this.dNames = ['Domingo','Lunes','Martes','Miercoles','Jueves','Viernes','Sabado'];
	this.eAbbr = ['BCE','CE'];
	this.mAbbr = [ 'Ene','Feb','Mar','Abr','May','Jun','Jul','Ago','Sep','Oct','Nov','Dic' ];
	this.mNames = [ 'Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre' ];
